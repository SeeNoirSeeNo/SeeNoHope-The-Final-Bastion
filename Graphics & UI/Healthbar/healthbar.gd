...
func create_floating_label(text_value, color: Color, velocity: Vector2, duration: float):
	...
	label_instance.start_floating_label(text_value, color, velocity, duration)
