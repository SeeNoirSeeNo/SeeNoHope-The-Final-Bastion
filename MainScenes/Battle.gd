...
func _ready():
	...
	unit_factory.create_unit("BananaMan", Vector2i(3,18), "Player", "Player", true)
	unit_factory.create_unit("CaveGoblin", Vector2i(4,18), "Player", "Player", true)
	unit_factory.create_unit("BananaMan", Vector2i(17,8), "Enemy", "Enemy", true)
	unit_factory.create_unit("FlyingEye", Vector2i(15,3), "Enemy", "Enemy", true)
	unit_factory.create_unit("BananaMan", Vector2i(17,3), "Enemy", "Enemy", true)
