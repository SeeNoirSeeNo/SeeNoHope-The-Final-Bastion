...
func _ready():
	...
	unit_factory.create_unit("FlyingEye", Vector2i(17,3), "Player", "Player", true)
	unit_factory.create_unit("BananaMan", Vector2i(18,5), "Player", "Player", true)
	...
	unit_factory.create_unit("Necromancer", Vector2i(4,18), "Enemy", "Enemy", true)
	unit_factory.create_unit("FlyingEye", Vector2i(5,18), "Enemy", "Enemy", true)
